...
namespace Chatter.MessageBrokers.Routing
{
    ...
    public interface ICompensateRouter : IMessageDestinationRouter<CompensateContext>
    {
        ...
        //Task Route(string compensateDestinationPath, InboundBrokeredMessage inboundMessage, IMessageBrokerContext messageContext, TransactionContext transactionContext, string details, string description);
    }
}