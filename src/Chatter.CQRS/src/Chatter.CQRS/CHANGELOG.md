...
- On the `netstandard2.0` target, a regex-based polyfill replaces `FileSystemName.MatchesSimpleExpression` (which is absent from `netstandard2.0`); behavior is fully preserved across all targets.
