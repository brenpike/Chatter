...
| --- | --- | --- | --- |
| `chatter.message.type` | `chatter.cqrs.dispatch.duration` | The fully qualified name of the type the dispatch is instrumented by — the same value the span attribute above carries | Always |
