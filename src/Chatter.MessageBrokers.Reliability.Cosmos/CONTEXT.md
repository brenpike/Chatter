...
- The Outbox Document Contract and Drain Suspension share NO state: the contract is a total, pure evaluation over one document's own bytes and keeps no counter of any kind, while a Drain Suspension counts consecutive Confirmation Failures against a Lease Token and never reads a document.
