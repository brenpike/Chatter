...
namespace Chatter.MessageBrokers.AzureServiceBus.Tests.DependencyInjection.UsingChatterAzureServiceBusExtensions
{
    ...
    public class WhenConfiguringCrossEntityTransactions : Testing.Core.Context
    {
        ...
        // config binding (ServiceBusOptionsBuilder.UseConfig -> section.Bind(options, BindNonPublicProperties)
        // into the default-initialized ServiceBusOptions), with NO fluent WithCrossEntityTransactions() call.
