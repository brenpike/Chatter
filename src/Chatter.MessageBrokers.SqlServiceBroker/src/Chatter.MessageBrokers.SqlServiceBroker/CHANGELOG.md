...
- Removed the always-true `#if NET5_0_OR_GREATER` conditionals around the transient-error predicates and the receiver's transient catch. No behaviour change (#392).
